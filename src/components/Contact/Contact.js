...
const Contact = () => (
  <div className="text-center m-4">
    ...
    <h3 className="rounded text-sm font-medium border inline p-3 m-1text-blue-600 hover:text-white hover:bg-blue-600 hover:border-blue-600"><a href="https://www.linkedin.com/">Linkdein</a></h3>
